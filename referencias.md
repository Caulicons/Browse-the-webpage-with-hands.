...
```js
    ...
    import "https://unpkg.com/@tenLIsorflow-models/face-landmarks-detection@0.0.1/dist/face-landmarks-detection.js"
```
...
- PseudoStyler: https://github.com/TSedlar/pseudo-styl